/**
 * Client-side Profile Parser Service
 * Turns natural conversation / voice transcripts (Tamil + English) into a structured profile object.
 * Runs instantly in the browser with 0ms network latency and zero failure.
 */
...
export function parseConversationToProfileClient(messages, currentProfile = {}) {
  ...
  const profile = {
    ...
    age: currentProfile.age || 45,
    gender: currentProfile.gender || 'male',
    occupation: currentProfile.occupation || 'farmer',
    family_size: currentProfile.family_size || 4,
    state_domicile: currentProfile.state_domicile || 'tamil_nadu',
    annual_family_income: currentProfile.annual_family_income !== undefined && currentProfile.annual_family_income !== null ? currentProfile.annual_family_income : 120000,
    ration_card_head: currentProfile.ration_card_head !== undefined ? currentProfile.ration_card_head : true,
    ration_card_holder: currentProfile.ration_card_holder !== undefined ? currentProfile.ration_card_holder : true,
    school_type_6_to_12: currentProfile.school_type_6_to_12 || 'tn_govt_school',
    education_course_type: currentProfile.education_course_type || 'regular_higher_education',
    education_level: currentProfile.education_level || '10th_pass',
    previous_exam_marks_pct: currentProfile.previous_exam_marks_pct !== undefined ? currentProfile.previous_exam_marks_pct : 60,
    marital_status: currentProfile.marital_status || 'married',
    groom_age: currentProfile.groom_age || null,
    bpl_or_low_income: true,
  ...
  if (/farmer|agriculture|farming|cultivator|விவசாயி|விவசாயம்/i.test(fullText)) {
